- # BA Financial Analysis – Requirements Specification
  ...
  Version: **1.2** (Includes Strict Monthly Engine, Consolidated Cash Flow, and RMD Injection Logic)
  ...
  - **Income Precision:**
    ...
    - **Proration:** Social Security (FICA) payments in the first eligible year are prorated starting from the birth month (or designated start month) rather than the full year.
