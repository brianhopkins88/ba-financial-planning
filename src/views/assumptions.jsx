  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      ...
      <Section title="1. Global Economic Assumptions" defaultOpen={true}>
        <NumberInput label="General Inflation (CPI)" value={assumptions.inflation.general} path="assumptions.inflation.general" step="0.001" suffix="dec" updateData={updateData} />
        <NumberInput label="Medical Inflation" value={assumptions.inflation.medical} path="assumptions.inflation.medical" step="0.001" suffix="dec" updateData={updateData} />
        <NumberInput label="Property Tax Cap" value={assumptions.inflation.propertyTax} path="assumptions.inflation.propertyTax" step="0.001" suffix="dec" updateData={updateData} />

        <div className="col-span-full h-px bg-slate-100 my-2"></div>

        <NumberInput label="Market Return (Initial)" value={assumptions.market.initial} path="assumptions.market.initial" step="0.001" suffix="dec" updateData={updateData} />
        <NumberInput label="Market Return (Terminal)" value={assumptions.market.terminal} path="assumptions.market.terminal" step="0.001" suffix="dec" updateData={updateData} />
        <NumberInput label="Return Taper End Age" value={assumptions.market.taperEndAge} path="assumptions.market.taperEndAge" step="1" suffix="yrs" updateData={updateData} />

        <div className="col-span-full h-px bg-slate-100 my-2"></div>

        <NumberInput label="Reverse Mortgage Rate" value={assumptions.rates?.reverseMortgage || 0.065} path="assumptions.rates.reverseMortgage" step="0.001" suffix="dec" updateData={updateData} />
        <NumberInput label="Reverse Mort. Trigger (401k Min)" value={assumptions.thresholds?.retirementMin || 300000} path="assumptions.thresholds.retirementMin" step="1000" updateData={updateData} />
      </Section>

      {/* 2. REAL ESTATE MODELING */}
      <Section title="2. Real Estate Growth Model" defaultOpen={false}>
         <div className="col-span-full bg-slate-50 p-3 rounded text-xs text-slate-500 mb-2">
            Home values grow based on an Age-Curve: <strong>Baseline + Add-on</strong>. Add-ons decrease as the home ages from New to Mid to Mature.
         </div>
         <NumberInput label="Macro Baseline Growth" value={assumptions.property.baselineGrowth} path="assumptions.property.baselineGrowth" step="0.001" suffix="dec" updateData={updateData} />
         <NumberInput label="Max Growth Cap" value={assumptions.property.maxGrowth} path="assumptions.property.maxGrowth" step="0.001" suffix="dec" updateData={updateData} />
         <div className="hidden lg:block"></div>

         <div className="col-span-full h-px bg-slate-100 my-2"></div>

         <NumberInput label="New Home Add-on" value={assumptions.property.newHomeAddon} path="assumptions.property.newHomeAddon" step="0.001" suffix="+" updateData={updateData} />
         <NumberInput label="Mid-Age Add-on" value={assumptions.property.midHomeAddon} path="assumptions.property.midHomeAddon" step="0.001" suffix="+" updateData={updateData} />
         <NumberInput label="Mature Add-on" value={assumptions.property.matureHomeAddon} path="assumptions.property.matureHomeAddon" step="0.001" suffix="+" updateData={updateData} />

         <NumberInput label="New Home Duration" value={assumptions.property.newHomeYears} path="assumptions.property.newHomeYears" step="1" suffix="yrs" updateData={updateData} />
         <NumberInput label="Mid-Age Duration" value={assumptions.property.midHomeYears} path="assumptions.property.midHomeYears" step="1" suffix="yrs" updateData={updateData} />
      </Section>
